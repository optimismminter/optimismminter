...
const WalletDropdown = forwardRef(({ account, onDisconnect, onClose,setNotification }, ref) => {
  ...
  return (
    <div 
      className="absolute top-full left-0 mt-2 w-48 bg-[#fff] rounded-xl overflow-hidden shadow-lg border border-[#fff] z-50 text-[#111]"
      onClick={(e) => e.stopPropagation()} 
      ref={ref}
    >
      <button
        className="w-full px-4 py-3 text-left hover:bg-[#d9d9d9] flex items-center gap-3"
